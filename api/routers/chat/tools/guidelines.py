...
SCHEMAS = [
    {
        ...
        "input_schema": {
            ...
            "properties": {
                "disease": {
                    "type": "string",
                    "description": "Disease name in Chinese or English, e.g. '非小细胞肺癌', 'NSCLC', 'breast cancer', '乳腺癌'",
                },
                "line": {
                    "type": "string",
                    "description": "Treatment line filter, e.g. '一线', '二线', '三线'. Omit for all lines.",
                },
                "source": {
                    "type": "string",
                    "description": "Guideline source filter, e.g. 'NCCN', 'CSCO', 'ESMO'. Omit for all sources.",
                },
    ...
    },
    {
        ...
        "input_schema": {
            ...
            "properties": {
                "disease": {
                    "type": "string",
                    "description": "Disease name, e.g. '非小细胞肺癌', 'breast cancer'",
                },
                "biomarker": {
                    "type": "string",
                    "description": "Optional: specific biomarker name, e.g. 'PD-L1', 'EGFR', 'HER2'. Omit for all biomarkers.",
                },
            },
            "required": ["disease"],
        },
    },
    {
        ...
        "input_schema": {
            ...
            "properties": {
                "disease": {
                    "type": "string",
                    "description": "Disease name filter. Omit for all diseases.",
                },
                "source": {
                    "type": "string",
                    "description": "Source filter (NCCN/CSCO/ESMO/etc). Omit for all sources.",
                },
            },
        },
    },

...
| M-008 | 2026-04-24 | maintainability | B1/B2/B4 | medium | in-progress | L | n/a | api/services/document/rnpv_excel.py | Started at 24 C901 > 10. PRs #35, #48, #50, #51, #55, #56, #57, #59 (sensitivity 12→<10). build_patient_funnel (was 13) now in `rnpv/patient_funnel.py` — geo block (static funnel + year-by-year projection) + indication section + grand total + chart each own helper. 1 C901 sheet builder left in rnpv_excel.py: `build_revenue=13` | Final sheet split next: `build_revenue_sheet` |

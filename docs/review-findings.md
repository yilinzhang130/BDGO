...
| M-008 | 2026-04-24 | maintainability | B1/B2/B4 | medium | in-progress | L | n/a | api/services/document/rnpv_excel.py | Started at 24 C901 > 10. PRs #35, #48, #50, #51, #55, #56 (qc 15→<10). build_references (was 12) now in `rnpv/references.py` — `_auto_collect_references`, `_write_reference_row`, `_compute_coverage` each C<5. 3 C901 sheet builders still in rnpv_excel.py: `build_patient_funnel=13, build_revenue=13, build_sensitivity=12` | Continue one per PR. `build_sensitivity_sheet` next |

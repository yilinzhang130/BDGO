...
│  Stage 3 — 会议准备 + NDA                                         │
│                                                                  │
│  /meeting counterparty=X meeting_purpose=intro_pitch  ← NEW S3-03│
│    ├→ chip /log status=meeting                                   │
│    ├→ chip /email purpose=follow_up  (intro_pitch)               │
│    ├→ chip /dd perspective=seller    (data_room_review)          │
│    └→ chip /draft-ts                 (term_sheet)                │
└─────────────────────────────────────────────────────────────────┘

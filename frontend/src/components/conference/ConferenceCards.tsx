...
export function CompanyCard({ card, onClick }: { card: ConferenceCompanyCard; onClick: () => void }) {
...
export function StatChip({ icon, label, value, color }: { icon: string; label: string; value?: number; color: string }) {

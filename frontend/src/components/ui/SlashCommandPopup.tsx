...
>[] = [
  {
    alias: "paper",
    slug: "paper-analysis",
    example: "KRAS G12C 耐药机制 综述 最近3年 15篇",
    category: "A",
  },
  ...
  },
  {
    alias: "dd",
    slug: "dd-checklist",
    example: "某 KRAS G12C 抑制剂 III期 BIC 买方视角",
    category: "B",
  },
  {
    alias: "faq",
  ...
  },
  {
    ...
    example: "三阴乳腺癌 ADC 中国市场",
    category: "A",
  },
  {
    alias: "disease",
    slug: "disease-landscape",
    example: "特发性肺纤维化 全球竞争格局",
    category: "A",
  },
  ...
  { alias: "ip", slug: "ip-landscape", example: "GLP-1 口服小分子 FTO", category: "A" },
  {
    ...
    example: "NSCLC 一线 NCCN 2025",
    category: "A",
  },
  {
    alias: "evaluate",
    slug: "deal-evaluator",
    example: "某 Claudin18.2 ADC 临床II期 买方吸引力",
    category: "A",
  },
  {
    alias: "rnpv",
    slug: "rnpv-valuation",
    example: "某 KRAS G12C 抑制剂 NSCLC 二线 上市概率35%",
    category: "A",
  },
  {
    alias: "teaser",
    slug: "deal-teaser",
    example: "某 BCMA CAR-T 临床I期 寻求海外授权",
    category: "B",
  },
  {
    alias: "legal",
    slug: "legal-review",
    example: "Term Sheet v3 重点看里程碑与终止条款",
    category: "A",
  },
  {
    alias: "email",
    slug: "outreach-email",
    example: "向默沙东 BD 介绍我们的 KRAS G12D 资产",
    category: "C",
  },
  {
    alias: "batch-email",
  ...
  { alias: "company", slug: "company-analysis", example: "Biogen", category: "A" },
  {
    alias: "synthesize",
    slug: "bd-synthesize",
    example: "Q2 自免 BD 策略 重点 IRF5 / TYK2",
    category: "A",
  },
  {
    alias: "timing",
    slug: "timing-advisor",
    example: "某 Claudin18.2 ADC 何时启动海外 BD",
    category: "B",
  },
  {
    alias: "meeting",
  ...
  },
  {
    alias: "log",
    slug: "outreach-log",
    example: "2026-04-25 与诺华 BD 通话 讨论 IRF5 资产",
    category: "C",
  },
  {
    alias: "outreach",
    slug: "outreach-list",
    example: "IRF5 自免 找潜在买方 Top 10",
    category: "C",
  },
  {
    alias: "import-reply",
  ...
  },
  {
    alias: "dataroom",
    slug: "data-room",
    example: "某 BCMA CAR-T 临床II期 海外授权 数据室清单",
    category: "B",
  },
  {
    alias: "draft-ts",

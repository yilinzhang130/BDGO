...
import { AbstractCard, CompanyCard, StatChip } from "@/components/conference/ConferenceCards";
...
export default function ConferencePage() {
  ...
  useEffect(() => {
    setPage(1);
  }, [activeSession, q, companyType, country, kind, view]);
  ...
  return (
    <div style={{ display: "flex", height: "100vh", background: "#f8fafc", overflow: "hidden" }}>
          ...
          {stats && (
            <div style={{ display: "flex", gap: 20, marginBottom: 12, flexWrap: "wrap" }}>
              <StatChip
                icon="🏢"
                label="BD公司"
                value={stats.total_companies ?? stats.total_bd_heat_companies}
                color="#1d4ed8"
              />
      ...
      <ConferenceChatSidebar
        ...
        contextHint={
          view === "abstracts"
            ? `摘要视图${kind ? "-" + kind : ""}${country ? "-" + country : ""}`
            : "公司视图"
        }

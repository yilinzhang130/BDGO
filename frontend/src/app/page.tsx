...
const FEATURES = [
  {
    icon: "🤖",
    title: "多 Agent 协作",
    desc: "多个专精 Agent 分工协作——意图理解、多步检索、交叉分析、结构化输出一气呵成",
  },
  {
    icon: "💬",
    title: "自然语言对话",
    desc: "中英文提问，一次对话即可调度多个 Agent，所有结论均附引用来源可追溯",
  },
  {
    icon: "📊",
    title: "管线与竞争情报",
    desc: "跨治疗领域的资产梳理、靶点格局拆解、头对头比较，支持实时更新",
  },
  {
    icon: "📅",
    title: "催化剂日历",
    desc: "聚焦临床数据读出、监管决策与里程碑节点，帮助团队锁定关键时点",
  },
  {
    icon: "🎯",
    title: "买方画像 Agent",
    desc: "自动拆解 MNC 管线策略、历史 BD 图谱、战略 gap 与可交易机会矩阵",
  },
  {
    icon: "📄",
    title: "自动化报告",
    desc: "公司分析、买方画像、资产评估、立项备忘——格式专业、可直接分享",
  },
];
        ...
        {agents.map((a) => (
          <div key={a.name}>
            ...
            <div style={{ height: 4, background: "#F1F5F9", borderRadius: 2, overflow: "hidden" }}>
              <div
                style={{ width: `${a.pct}%`, height: "100%", background: a.color, borderRadius: 2 }}
              />
            </div>
          </div>
        ))}
...
export default function LandingPage() {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            {!loading &&
              (user ? (
                <Link href="/chat" style={btn.primary}>
                  进入平台 →
                </Link>
              ) : (
                <>
      ...
      {/* ─── Hero ─── */}
      <section
        style={{ background: "#fff", padding: "80px 32px 96px", borderBottom: "1px solid #F1F5F9" }}
      >
        <div
          style={{
            maxWidth: 1160,
        ...
        >
          ...
          <div style={{ flex: "1 1 420px", minWidth: 300 }}>
            ...
            >
              ...
              <span
                style={{ fontSize: 12, fontWeight: 600, color: "#3730A3", letterSpacing: "0.02em" }}
              >
                首个面向 BD 与立项的多 Agent 平台
              </span>
            </div>
            <h1
              style={{
            ...
            >
              BD Go 是业内首个面向 BD 与立项场景的多 Agent 协作平台。多个专精 Agent
              分工协作，帮助团队在资产发现、买方画像与立项评估中更快做出高质量决策。
            </p>
            <div style={{ display: "flex", gap: 14, flexWrap: "wrap", marginBottom: 36 }}>
              <Link href={ctaHref} style={btn.primaryLg}>
                免费开始使用 →
              </Link>
      ...
      >
        ...
        >
          <div style={{ flex: "1 1 380px", color: "#fff" }}>
            ...
            >
              BD Go AI 调度多个专精 Agent
              协同工作——从意图理解到多步检索、交叉分析、结构化输出，所有结论均附引用来源可追溯。
            </p>
            {[
              "支持中英文自然语言提问",
              "多 Agent 分工协作，覆盖 BD 与立项",
              "结论均附引用来源可追溯",
              "一键导出 Word / PPT 报告",
            ].map((t) => (
              <div
          ...
          <div style={{ flex: "1 1 340px" }}>
            ...
            >
              <div style={{ fontSize: 11, color: "#93C5FD", marginBottom: 14, fontWeight: 500 }}>
                示例查询：
              </div>
              <div
                style={{
              ...
              >
                <svg width="14" height="14" viewBox="0 0 16 16" fill="white">
                  <path d="M8 1l1.76 3.57 3.94.57-2.85 2.78.67 3.9L8 10.36 4.48 12.32l.67-3.9L2.3 5.64l3.94-.57L8 1z" />
                </svg>
                <span style={{ fontSize: 12, color: "#E0EFFE", fontWeight: 500 }}>
                  资产发现 Agent 已调度，正在生成分析报告…
                </span>
              </div>
            </div>
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 28 }}>
            ...
            >
              ...
              <p style={{ fontSize: 14, lineHeight: 1.7, color: "#3730A3", margin: "0 0 28px" }}>
                业内首个面向 BD 与立项的多 Agent 协作平台。多个专精 Agent
                分工协作，自动完成资产发现、买方画像、立项评估与 DD 报告。
              </p>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 20 }}>
                ...
                <div>
                  <div style={{ fontSize: 18, fontWeight: 800, color: "#064E3B" }}>
                    AIDD <span style={{ fontWeight: 500 }}>Platform</span>
                  </div>
      ...
      >
        ...
        <div style={{ position: "relative", maxWidth: 680, margin: "0 auto", textAlign: "center" }}>
          ...
          >
            业内首个面向 BD 与立项的多 Agent 协作平台，首批内测席位开放中——让多个 Agent
            为您并肩工作。
          </p>
          <div
            style={{
          ...
          >
            <Link href={ctaHref} style={{ ...btn.primaryLg, background: "#fff", color: "#1E3A8A" }}>
              免费试用 →
            </Link>
            <Link
              href="/login"
      ...
      {/* ─── Footer ─── */}
      <footer
        style={{ background: "#fff", borderTop: "1px solid #F1F5F9", padding: "56px 32px 32px" }}
      >
        <div style={{ maxWidth: 1160, margin: "0 auto" }}>
          <div
            style={{
